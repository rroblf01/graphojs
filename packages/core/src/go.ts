...
// GoJS names this class "Quadtree" (lowercase t); kept as an alias here so
// code written against real GoJS's exact casing (`new go.Quadtree()`) works.
export { QuadTree, QuadTree as Quadtree } from './spatial/QuadTree.ts';
