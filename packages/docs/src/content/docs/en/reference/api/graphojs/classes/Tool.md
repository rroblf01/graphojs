...
Defined in: [tool/Tool.ts:7](https://github.com/rroblf01/graphojs/blob/aa122e30a116d47c3df4e406066e615bceb89e4e/packages/core/src/tool/Tool.ts#L7)

Base class for all interaction tools.

## Extended by

- [`ActionTool`](/en/reference/api/graphojs/classes/actiontool/)
