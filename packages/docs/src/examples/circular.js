...
const palette = ['#f44336', '#e91e63', '#9c27b0', '#673ab7', '#3f51b5', '#2196f3', '#00bcd4', '#009688', '#4caf50', '#8bc34a', '#ffc107', '#ff5722'];
...
diagram.nodeTemplate = $(
  ...
  $(go.TextBlock, 'label', { margin: 4, font: '700 12px system-ui, sans-serif', stroke: '#fff' },
